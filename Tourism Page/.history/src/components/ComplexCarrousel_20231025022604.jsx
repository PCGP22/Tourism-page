    ...
    <>
      <div className="images__grid">
        ...
        <img
          ...
          className="images__grid__three"
        />
        <img
          src={family}
          alt="family"
          height="100"
          onClick={() => setInitial(3)}
          className="images__grid__four"
        />
        <img
          src={tryOut}
          alt="try"
          height="100"
          onClick={() => setInitial(4)}
          className="images__grid__five"
        />
        <img
          src={enjoy}
          alt="enjoy"
          height="100"
          onClick={() => setInitial(5)}
          className="images__grid__six"
        />
      </div>

...
import { visibleContext } from "../context/languageContext";
    ...
    <div className="complexCarrousel">
      <div className="images__grid">
        <img
          ...
          className="images__grid__one images__grid__img revealFromLeft"
        />
        <img
          src={learn}
          alt="learn"
          ...
          className="images__grid__two images__grid__img revealFromRight"
        />
        <img
          src={relax}
          alt="relax"
          ...
          className="images__grid__three images__grid__img revealFromLeft"
        />
        <img
          src={family}
          alt="family"
          ...
          className="images__grid__four images__grid__img revealFromRight"
        />
        <img
          src={tryOut}
          alt="try"
          ...
          className="images__grid__five images__grid__img revealFromLeft"
        />
        <img
          src={enjoy}
          alt="enjoy"
          ...
          className="images__grid__six images__grid__img revealFromRight"
        />
      </div>
      <div
        className={`${
          visible
            ? "carrousel__container--visible"
            : "carrousel__container--hidden"
        }`}>
